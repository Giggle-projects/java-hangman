...
public interface Message {
    ...
    String ERR_INPUT_RANGE = "You just typed more than one character. Please retype one character.";
    String ERR_NUMBER_FORMAT_EXCEPTION = "The letter you just typed is not a digit. Please retype the digit.";
